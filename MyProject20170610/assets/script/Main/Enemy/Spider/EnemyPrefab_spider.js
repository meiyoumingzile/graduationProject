cc.Class({
    ...
    onLoad: function () {
        ...
        if(this.state_character=="Enemy_spider1_"){
            this.Public.life=cc.v2(1,1);
            this.damage=1;
        }else if(this.state_character=="Enemy_spider2_"){
            this.Public.life=cc.v2(3,3);
            this.damage=1;
            this.node.color=cc.Color.YELLOW;
            this.state_character=this.state_character.replace("2","1");
        }else if(this.state_character=="Enemy_spider3_"){
        ...
        this.playState=this.state_character.slice(0,13);
