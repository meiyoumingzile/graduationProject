...
window["THREE"]["OBJLoader"] = ( function () {
			...
			for ( var i = 0, l = state.objects.length; i < l; i ++ ) {
				...
				if ( createdMaterials.length > 1 ) {
					...
					if ( isLine ) {
						...
						mesh = new THREE.Points( buffergeometry, createdMaterials as any );
...
let a:any = function ( object, domElement ) {
	...
	function handleMouseDownRotate( event ) {
		...
		//egret.log( 'handleMouseDownRotate' );
	...
	function handleMouseDownDolly( event ) {
		...
		//egret.log( 'handleMouseDownDolly' );
	...
	function handleMouseMoveRotate( event ) {
		...
		//egret.log( 'handleMouseMoveRotate' );
	...
	function handleMouseMoveDolly( event ) {
		...
		//egret.log( 'handleMouseMoveDolly' );
	...
	function handleMouseUp( event ) {
		...
		// egret.log( 'handleMouseUp' );

	}

	function handleMouseWheel( event ) {

		// egret.log( 'handleMouseWheel' );
	...
	function handleTouchStartRotate( event ) {
		...
		//egret.log( 'handleTouchStartRotate' );
	...
	function handleTouchStartDollyPan( event ) {
		...
		//egret.log( 'handleTouchStartDollyPan' );
	...
	function handleTouchMoveRotate( event ) {
		...
		//egret.log( 'handleTouchMoveRotate' );
	...
	function handleTouchMoveDollyPan( event ) {
		...
		//egret.log( 'handleTouchMoveDollyPan' );
...
THREE.OrbitControls = a;
THREE.OrbitControls.prototype = Object.create( THREE.EventDispatcher.prototype ) as any;
...
let ParametricGeometries:any = {
	...
	plane2: function ( u, v, target ) {
			...
			if(u>0){
				...
				y = 0;
			 	// y = v*v*2;
				x = 40*Math.sin(u/80-Math.PI/2)+v*10+40;
			}
